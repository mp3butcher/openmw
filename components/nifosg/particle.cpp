...
ParticleRotationAffector::ParticleRotationAffector(const Nif::NiParticleRotation *clrdata)
  //  : mData(clrdata->mRotation Speed mKeyMap, osg::Vec4f(1,1,1,1))
{
...
void ParticleRotationAffector::operate(osgParticle::Particle* particle, double /* dt */)
{
    ...
    {
        osg::Vec3 initialAxis=osg::Vec3f(Misc::Rng::rollClosedProbability()*2.0*osg::PI,Misc::Rng::rollClosedProbability()*2.0*osg::PI,Misc::Rng::rollClosedProbability()*2.0*osg::PI);
